import { AfterContentInit, Directive, EventEmitter, Input, OnChanges, OnDestroy, Output, SimpleChanges, Component } from '@angular/core';
...
export class AppComponent {
  //-11.879501, -77.080279
  lat: number = -11.879501;
  lng: number = -77.080279;
  zoom: number = 11;
  paths: LatLngLiteral[] = [
    
  { lat: -11.889913, lng: -77.076659 },
  { lat: -11.891273, lng: -77.069019 },
  { lat: -11.879972, lng: -77.069453 },
  { lat: -11.879463, lng: -77.075010 },
  { lat: -11.889913, lng: -77.075010 }
  ]
